      ...
      <Dialog as="div" className="fixed z-10 inset-0 overflow-y-auto" onClose={()=>setopen(false)}>
        <div className="flex  text-center md:block md:px-2 lg:px-4" style={{ fontSize: 0 }}>
          <Transition.Child
            ...
            leaveTo="opacity-0"
          >
            <Dialog.Overlay className="hidden fixed inset-0 bg-transparent  transition-opacity " />
          </Transition.Child>
              ...
              <div className="w-full relative flex items-center bg-white px-4 pt-14 pb-8 overflow-hidden shadow-2xl sm:px-6 sm:pt-8 md:p-6 lg:p-8">
                ...
                <div className="w-full grid grid-cols-1 gap-y-8 gap-x-6 items-start sm:grid-cols-12 lg:gap-x-8">
                  ...
                  <div className="sm:col-span-8 lg:col-span-7">
                    <h2 className="text-2xl font-extrabold text-gray-900 sm:pr-12">{pro}</h2>
                    ...
                    <section aria-labelledby="information-heading" className="mt-2">
                      ...
                      <p className="text-2xl text-gray-900">{props.post.price}</p>
