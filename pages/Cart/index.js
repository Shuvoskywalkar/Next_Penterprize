...
<section className="bg-gray-100">
  <div className="container mx-auto mt-10">
    <div className="flex shadow-md my-10">
      ...
      <div id="summary" className="hidden md:block w-full md:w-1/4 px-8 py-10">
        ...
        <button style={{backgroundColor:"#212121"}} className=" hover:bg-red-600 px-5 py-2 text-sm text-white uppercase">Apply</button>
    ...
    <div id="summary" className="block md:hidden w-full md:w-1/4 px-8 py-10">
        <h1 className="font-semibold text-2xl border-b pb-8">Order Summary</h1>
        <div className="flex justify-between mt-10 mb-5">
          <span className="font-semibold text-sm uppercase">Items 3</span>
          <span className="font-semibold text-sm">590$</span>
